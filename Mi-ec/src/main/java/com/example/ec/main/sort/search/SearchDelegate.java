...
public class SearchDelegate extends MiDelegate {
    ...
    private void saveItem(String item) {
        if (!StringUtils.isEmpty(item) && !StringUtils.isSpace(item)) {
            ...
            final String historyStr =
                    MiPreference.getCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY);
            ...
            MiPreference.addCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY, json);
        }
    }
